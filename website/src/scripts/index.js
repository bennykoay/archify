  ...
  const LANGS = {
    en: {
      ...
      'step1-h':'Install in one command','step1-p':'Run <code>npx skills add tt-a1i/archify -g</code>, or use the <a href="start.html?agent=cursor&amp;type=architecture">agent-aware quick start</a>. For Raven, extract archify.zip into <code>~/.raven/workspace/skills</code>.',
    ...
    zh: {
      ...
      'step1-h':'一条命令安装','step1-p':'运行 <code>npx skills add tt-a1i/archify -g</code>，或使用<a href="start.html?agent=cursor&amp;type=architecture">可切换 Agent 的快速开始页</a>。Raven 请手动将 archify.zip 解压到 <code>~/.raven/workspace/skills</code>。',
